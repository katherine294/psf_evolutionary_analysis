...
Read in vcf file
```{r}
vcf <- read.vcfR("~/Figure1-source-data.vcf")
...
# Save matrix to file
write_csv(snp_dist_matrix, "snp_dist_binary_masked.csv")
```
...
#### Combine all distance measures for site, tree and tissue ####

# Join tissue, tree, site by left_join
...
# Filter out sites that have less than 2 strains
long_df <- long_df %>%
