...
metadata <- read.csv("~/OneDrive - University of Birmingham/Genotype-phenotype paper/Data for figures/strains_r_input.csv")

# Keep only strains that exist in the distance matrix
meta_subset <- metadata[metadata$Strain %in% rownames(snp_dist_matrix), ]

# Function to compute mean intra-site distances
...
write.table(intra_site_diversity, "~/OneDrive - University of Birmingham/Genotype-phenotype paper/Data for figures/Section 3 - Genomic analysis/Phylogeny/intra_site_diversity.txt", sep="\t", quote=FALSE)

##### Function to compute mean intra-tree SNP distances #####
...
write_csv(intra_tree_diversity, "~/OneDrive - University of Birmingham/Genotype-phenotype paper/Data for figures/Section 3 - Genomic analysis/Phylogeny/tree_diversity.csv")


######## Intra-tissue diversity #########
...
intra_group_diversity <- metadata %>%
...
write_csv(intra_group_diversity, "~/OneDrive - University of Birmingham/Genotype-phenotype paper/Data for figures/Section 3 - Genomic analysis/Phylogeny/tissue_diversity.csv")
